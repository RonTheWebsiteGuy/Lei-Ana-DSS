...
// NOTE: THIS IS AN EXAMPLE TEMPLATE OF HOW OUR WEBSITE WILL BE STRUCTURED
// THE header.php and footer.php are includes which will be repeated on every page
// the title will be taken care of in this varialble below $ title
// So, in every page you make, pretty much what you type after making the includes is everything that will go 
// between <body> and </body>
// please view header.php and footer.php to understand what is in them
